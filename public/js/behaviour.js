     ...
     success:function(result,status,xhr){
        ...
        $(".btn-event").prop('disabled', false);
            if(result.message==='empty'){
             ...
             $(".message").css({'background-color':"green"});
             $(".message-info").html(
               "<p style="+"margin:0;"+">Information has been taken.</p>Make a payment of Rs 50 on this upi 6299017113@upi and send the payment screenshot on reachscriptink@gmail.com.  <a class="+"message-anchor"+" href="+"https://play.google.com/store/apps/details?id=com.scriptink.official&hl=en"+"><i class="+"fab fa-google-play"+"></i></a>"
